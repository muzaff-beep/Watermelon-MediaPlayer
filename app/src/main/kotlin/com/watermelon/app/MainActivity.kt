            ...
            composable(
                ...
                if (controller == null || pbController == null) {
                    ...
                    PlayerScreen(
                        ...
                        vhsTier         = VhsCapability.detectTier(this@MainActivity),
                        vhsIntensity    = if (!settingsState.vhsEnabled) 0f else when (settingsState.vhsIntensity) {
                        ...
                        vhsRenderEffectProvider = { intensity, timeSec, w, h ->
                        ...
                        onRewindActive  = { active, speed ->
                            if (active) {
                                vhsReverseSound.start(speed)
                                vhsReverseSound.setSpeed(speed)
                            } else {
                                vhsReverseSound.stop()
                            }
                        },
